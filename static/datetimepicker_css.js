...
var MonthYearColor = "#363639"; //Font Color of Month and Year in Calendar header.
...
function RenderCssCal(bNewCal)
{
	...
	if (!winCal)
	{
		...
		span.style.backgroundColor = 'none'; //SpanBgColor;
		//###################ED span background
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
	...
	dtToday = new Date();
	dtToday.setHours(12,0,0,0); //###################ED mod to set time to default 12pm
